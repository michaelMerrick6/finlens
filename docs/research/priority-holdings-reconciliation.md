...
| Josh Gottheimer | 395 | 122 | 74 | 294 | New/changed securities, source rows and corporate actions. |
| April McClain Delaney | 250 | 339 | — | 11 | Repeated positions across children’s trusts; PTRs do not identify the individual trust. |
| Gilbert Cisneros | 643 | 883 | 590 | 517 | New/changed securities, account matches, source rows and corporate actions. |
...
| Tim Moore | 72 | 35 | 19 | 48 | Annual and all 35 PTR rows visually checked; HY conflict, missing baselines and corporate actions remain. |
