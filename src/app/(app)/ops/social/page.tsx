...
export const metadata: Metadata = {
  title: 'Vail Broadcast Review',
  description: 'Internal curated broadcast review queue for Vail.',
  robots: {
    index: false,
    follow: false,
  },
    ...
    <div className="mx-auto max-w-6xl space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-semibold text-white">Curated Broadcast Queue</h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--text-secondary)]">
            Manual review board for quality insights before they go to X or premium Discord. This queue is policy-driven and separate from private user alerts.
          </p>
        </div>
