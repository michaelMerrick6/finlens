...
import {
  getSignalPolicyPath,
  readSignalPolicyText,
  signalPolicyWritesDisabledMessage,
  signalPolicyWritesEnabled,
...
export default async function SignalPolicyPage() {
  const canSave = signalPolicyWritesEnabled();
  ...
  return (
    <div className="space-y-8">
      ...
      <SignalPolicyEditor
        ...
        canSave={canSave}
        saveHelpText={canSave ? null : signalPolicyWritesDisabledMessage()}
      />
    </div>
  );
}
